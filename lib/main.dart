    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor:const  Color.fromARGB(255, 5, 29, 90)),),
          home: MyHomePage(),
    ),);
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<FlSpot> createdata(List data) {
    ...
    for (int i = 0; i < data.length; i++) {
      result.add(FlSpot(i.toDouble(), data[i].toDouble())); // Random value between 0 and 100
    }
    return result;
  }
